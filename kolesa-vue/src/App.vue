<template>
  <div id="app">
            ...
            <div class="header__wrapper">
                <div class="header__left">
                    <button class="header__burger-btn">
                        <img class="burger__img" src="./assets/images/burger.svg" alt="menu">
                    </button>
                    <a class="header__logo" href="#">
                        <img class="header__logo-img" src="./assets/images/header_logo.svg" alt="Kolesa Logo">
                    </a>
                    <form class="header__form">
                        <input type="text" name="search" class="header__input" placeholder="Поиск">
                        <button class="header__search" type="button">
                            <img class="header__img" src="./assets/images/search-big.svg" alt="Поиск" >
                        </button>
                    </form> 
                </div>
                <div class="header__right">
                    <button class="header__user" type="button">
                        <img class="header__user-image" src="./assets/images/user-img.png" alt="User-image">
                ...
                <form class="header__right-search">
                    ...
                    <button class="header__right-btn" type="button" >
                        <img class="header__right-img" src="./assets/images/search-icon.svg" alt="Поиск">
                    </button>
                </form>
            </div>
        </div>
        ...
        <div class="container">
            <div class="main__wrapper">
                <aside class="sidebar">
                    <nav class="menu">
                        <ul class="menu__list">
                            <li class="menu__list-item"><a href="#" class="menu__list-link">Оргсхема</a></li>
                            <li class="menu__list-item"><a href="#" class="menu__list-link">Kolesa Team</a></li>
                            <li class="menu__list-item"><a href="#" class="menu__list-link active">Kolesa Shop</a></li>
                            <li class="menu__list-item"><a href="#" class="menu__list-link">Картина компании</a></li>
                            <li class="menu__list-item"><a href="#" class="menu__list-link">Новости</a></li>
                            <li class="menu__list-item"><a href="#" class="menu__list-link">Education</a></li>
                            <li class="menu__list-item"><a href="#" class="menu__list-link">Guidelines</a></li>
                            <li class="menu__list-item"><a href="#" class="menu__list-link">Библиотека</a></li>
                            <li class="menu__list-item"><a href="#" class="menu__list-link">FAQ</a></li>
                        </ul>
                    </nav>
                </aside>
                <div class="main__box">
                    ...
                    <div class="main__questions questions">
                        <button type="button" class="questions__get-scores questions__item_take"> Получить баллы</button>
                        <button type="button" class="questions__get-scores questions__item_how">Как получить баллы</button>
                        <button type="button" class="questions__get-scores questions__item_gift">Подарить баллы</button>
                    </div>
                    <div class="main__tabs category">
                        <button data-type="all" type="button" class="js__category-button category__item category__item--active">Все товары</button>
                        <button data-type="clothes" type="button" class="js__category-button category__item">Одежда</button>
                        <button data-type="accessories" type="button" class="js__category-button category__item">Аксессуары</button>
                    </div> 
            ...
            <div class="footer__wrapper">
                <div class="footer__left">
                    ...
                    <div class="footer__social">
                        <a class="footer__social-link" href="https://www.instagram.com/">
                            <img class="footer__item-icon" src="./assets/images/insta.svg" alt="instagram">
                        </a>
                        <a class="footer__social-link" href="https://www.youtube.com/">
                            <img class="footer__item-icon" src="./assets/images/youtube.svg" alt="youtube">
                        </a>
                        <a class="footer__social-link" href="https://www.vk.com/">
                            <img class="footer__item-icon" src="./assets/images/vk.svg" alt="vkontakte">
                        </a>
                    </div>
                </div>
                <div class="footer__right">
                    <div class="footer__content">
                        ...
                        <p class="footer__content-item">Не знаешь, с кем решить проблему?</p>
                    </div>
    ...
    <div class="modal-main-wrap js__modal">
        <div class="overlay">
        </div>
        <div class="modal-window-wrap js__modal-window-wrap">
            <div class="modal-wrapper">
                ...
                <div class="images">
                    <img class="images_element" src="./assets/images/product.jpg" alt="футболка" width="330" height="330">
                    <div class="images__items">
                    <img class="images__item" src="./assets/images/type1.png">
                    <img class="images__item active" src="./assets/images/type2.png">
